  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={handleAddWord} className="text-sm text-indigo-600 hover:text-indigo-500 font-medium">
          + Add Word
        </button>
      </div>
                  ...
                  <div className="pt-2 border-t border-gray-100 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 px-4 rounded text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {saving ? 'Saving…' : 'Save'}
                      </button>
                      <button
